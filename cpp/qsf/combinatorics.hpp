...
// that lets every worker thread / GPU lane compute its own independent slice of work.
// Shared by the distfind (min-weight) and codeaut (low-weight collection) engines.
//
